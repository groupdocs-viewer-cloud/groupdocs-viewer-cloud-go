...
/*
ViewApiService Converts input document file to format specified
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param format Requested conversion format: HTML, JPG, PNG or PDF
 * @param file Input file to convert
 * @param optional nil or *ViewApiConvertAndDownloadOpts - Optional Parameters:
     * @param "Pages" (optional.String) -  Pages range to render, like \&quot;1,2\&quot; or \&quot;3-5,10\&quot;
     * @param "Password" (optional.String) -  Input document password
...
func (a *ViewApiService) ConvertAndDownload(ctx context.Context, format string, file *os.File, localVarOptionals *ViewApiConvertAndDownloadOpts) (*os.File, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/viewer/convertAndDownload"
	...
	if localVarOptionals != nil && localVarOptionals.Pages.IsSet() {
		localVarQueryParams.Add("pages", parameterToString(localVarOptionals.Pages.Value(), ""))
	}
...
func (a *ViewApiService) CreateView(ctx context.Context, viewOptions ViewOptions) (ViewResult, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ViewResult
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/viewer/view"
...
func (a *ViewApiService) DeleteView(ctx context.Context, deleteViewOptions DeleteViewOptions) (*http.Response, error) {
	...
	// body params
	localVarPostBody = &deleteViewOptions
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
